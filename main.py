...
# Instantiate People
player1 = Person("Cyn  :", 3260, 132, 300, 34, player_spells, player_items)
player2 = Person("Nick :", 4160, 188, 311, 34, player_spells, player_items)
player3 = Person("Robot:", 3089, 174, 288, 34, player_spells, player_items)

enemy1 = Person("Imp    :", 1250, 130, 560, 325, enemy_spells, [])
enemy2 = Person("THE MAN:", 11200, 540, 525, 25, enemy_spells, [])
...
while running:
    ...
    for player in players:
        ...
        index = int(choice) - 1     # because the computer starts from 0
    ...
    # If player chooses to use magic
            ...
            player.choose_magic()
            magic_choice = int(input("    Choose magic:")) - 1  # directly reducing input by 1

            if magic_choice == -1:  # Go back to previous menu
                continue
            ...
            if spell.type == "white":
                ...
                if enemies[enemy].get_hp() == 0:
                    ...
                    del enemies[enemy]
    # If player chooses to use items
        elif index == 2:
            player.choose_items()
    ...
    # Once an item is used, the quantity is reduced
